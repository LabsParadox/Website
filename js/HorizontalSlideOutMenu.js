/**
 * HorizontalSlideOutMenu.js v1.0.0
...
;( function( window ) {
	...
	function HorizontalSlideOutMenu( el, options ) {	
		this.el = el;
		this.options = extend( this.defaults, options );
		this._init();
	}

	HorizontalSlideOutMenu.prototype = {
		defaults : {},
		_init : function() {
			this.current = -1;
			this.menu = this.el.querySelector( '.menu' );
			this.menuItems = this.el.querySelectorAll( '.menu > li' );
	...
	window.HorizontalSlideOutMenu = HorizontalSlideOutMenu;
